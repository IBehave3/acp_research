...
use crate::api::model::fitbit_model::ClientCreateFitbit;

use crate::api::model::fitbit_model::CreateFitbitAccelerometer;
use crate::api::model::fitbit_model::CreateFitbitBarometer;
use crate::api::model::fitbit_model::CreateFitbitGryoscope;
use crate::api::model::fitbit_model::CreateFitbitHeartRate;
use crate::api::model::fitbit_model::CreateFitbitOrientation;
