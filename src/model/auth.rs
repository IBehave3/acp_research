...
pub struct IdMappingSensorAuth {
...
#[derive(Serialize, Deserialize, Debug)]
pub struct IdMappingUserInformation {
...
pub struct IdMapping {
    ...
    #[serde(flatten)]
    pub user_auth: IdMappingUserAuth,

    #[serde(flatten)]
    pub sensor_auth: IdMappingSensorAuth,

    #[serde(flatten)]
    pub user_information: IdMappingUserInformation,
}
